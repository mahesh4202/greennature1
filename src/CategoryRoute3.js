...
const CategoryRoute3 = () => {
  return (
    <div className='container'>
        <div class="d-flex mt-3">
            <div style={{ width: "30%" }}>
                <img className='border74' src={Cat3} alt="Snow" style={{ width: "100%" }}/>
            </div>
